# docwise v2 Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Upgrade the docwise plugin with per-source knowledge files, TTL freshness, source verification, priority-weighted loading, starter profiles, configurable triggers, and a best-practice linter mode.
...
**Spec:** `docs/superpowers/specs/2026-03-21-docwise-design.md`
...
docwise indexes your documentation sources and delivers best-practice guidance while you code:
...
See [Design Spec](docs/superpowers/specs/2026-03-21-docwise-design.md) for full architecture.
